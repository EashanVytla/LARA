...
from lara.nn.common import get_activation
from lara.nn.common import Conv2dWS
from lara.utils.config_utils import register_class
...
def get_resnet_class(model_name):
    import lara.nn.features.resnet as _res
