...
import tree
from lara.utils.functional_utils import implements_method
from lara.utils.tree_utils import tree_value_at_path
from lara.utils.file_utils import f_join
...
def sequential_split_dataset(dataset: torch.utils.data.Dataset, split_portions: list[float]):
    ...
    """
    from lara.utils.functional_utils import accumulate
